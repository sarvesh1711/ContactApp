...
let a = User.newAdmin(11, "M", "IND")
console.log(a);
let u1 = a.newUser("sarvesh", "M", "IND")
let u2 = a.newUser("omkar", "M", "IND")
console.log(u1);
console.log(u2);

//console.log(a.findUser("sarvesh"));
// let u3 = a.newUser("sahil", "M", "IND")
// u1.createContact("hemant")
// console.log(a.createContact("sanket"));
// u1.createContact("hemant")
// console.log(u1.getAllContact());

// u1.createContactInfo(0, "mobile", 9833324840)
// u1.createContactInfo(0, "email", "sonawanesarvesh11@gmail.com")
// console.log(u1.getAllContact());
...
// console.log(u1.getAllContactInfo(0));
//u1.updateContact(0, "deshmukh")
// u1.deleteContact(2)

// console.log(a.getAllUsers());
// console.log(u1.getAllContact());

// a.updateUser(2, "fullName", "deshmukh")
// console.log(a.getAllUsers());

// u1.updateContact(0, "hemant")
// console.log(u1.getAllContact());
